...
_w_table::_w_table(_window *Window1,_project_data_ns::_project_data &Project_data):QDialog((QWidget*)Window1)
{
  ...
  Item->setFlags(Qt::ItemIsEnabled);
  Tablewidget->setItem(Pos,0,Item);
  Item = new QTableWidgetItem(_data_xrd_ns::Vec_tube_name[int(Project_data.Tube_type)]);
  Item->setFlags(Qt::ItemIsEnabled);
  Tablewidget->setItem(Pos,1,Item);
  Pos++;
  //
  ...
  Item->setFlags(Qt::ItemIsEnabled);
  Tablewidget->setItem(Pos,0,Item);
  Item = new QTableWidgetItem(QString("%1").arg(Project_data.Width));
  Item->setFlags(Qt::ItemIsEnabled);
  Tablewidget->setItem(Pos,1,Item);
  Pos++;
  //
  ...
  Item->setFlags(Qt::ItemIsEnabled);
  Tablewidget->setItem(Pos,0,Item);
  Item = new QTableWidgetItem(QString("%1").arg(Project_data.Height));
  Item->setFlags(Qt::ItemIsEnabled);
  Tablewidget->setItem(Pos,1,Item);
  Pos++;
  //
