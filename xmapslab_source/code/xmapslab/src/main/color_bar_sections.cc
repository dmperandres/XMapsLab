...
_color_bar_sections::_color_bar_sections(_palette_data_ns::_color_type Color_type1, int Num_steps1, std::vector<float> &Vec_values1, std::vector<QColor> &Vec_colors1, _window *Window1):
