...
{
  Layer_type=_layer_ns::_layer_type::LAYER_TYPE_MAP_TRIANGULATION;
  ...
  #include "shaders/triangulation.vert"
  };

  static const GLchar * P0_fs[]={
  #include "shaders/triangulation.frag"
  };
...
_layer_map_triangulation_ui::_layer_map_triangulation_ui(_window *Window1, std::string Name1)
{
  Window=Window1;
  Name=Name1;
...
_qtw_layer_map_triangulation::_qtw_layer_map_triangulation(_window *Window1,_layer_map_triangulation_ui *Filter1,std::string Box_name)
{
  Window=Window1;
  Filter=Filter1;
