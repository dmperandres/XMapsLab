...
_layer_dog::_layer_dog()
{
  ...
  Layer_type=_layer_ns::_layer_type::LAYER_TYPE_DOG;
...
_layer_dog_ui::_layer_dog_ui(_window *Window1, std::string Name1)
{
  Window=Window1;
  Name=Name1;
...
_qtw_layer_dog::_qtw_layer_dog(_window *Window1,_layer_dog_ui *Filter1,std::string Box_name)
{
  Window=Window1;
  Filter=Filter1;
