...
using namespace _layer_compound_combination_ns;

/*************************************************************************/

_layer_compound_combination::_layer_compound_combination()
{
  Layer_type=_layer_ns::_layer_type::LAYER_TYPE_COMPOUND_COMBINATION;
}
...
float _layer_compound_combination::compute_operation(std::vector<float>& Vec_intensities)
{
...
void _layer_compound_combination::add_input_data(std::vector<std::shared_ptr<cv::Mat> > &Vec_maps_intensities1, std::vector<float> &Vec_max_intensities1, std::vector<float> &Vec_percentages1,std::vector<float> &Vec_global_percentages1)
{
...
void _layer_compound_combination::update_map()
{
  ...
  if (Computed==false){
    ...
    if (Result_floats_image==nullptr){
      Result_floats_image=std::make_shared<cv::Mat>();
    ...
    std::shared_ptr<cv::Mat> Image_normalized=Vec_input_images[0];
    cv::Vec4f Pixel;
    for (int Row=0;Row<Result_floats_image->rows;Row++){
      for (int Col=0;Col<Result_floats_image->cols;Col++){
...
void _layer_compound_combination::update()
{
  update_map();
}
...
_layer_compound_combination_ui::_layer_compound_combination_ui(_window *Window1, std::string Name1)
{
  Window=Window1;
  Name=Name1;
  Qtw_layer_compound_combination_a=new _qtw_layer_compound_combination(Window1,this,Name);
}

/*************************************************************************/

_layer_compound_combination_ui::~_layer_compound_combination_ui()
{
  delete Qtw_layer_compound_combination_a;
}

/*************************************************************************/

void _layer_compound_combination_ui::reset_data()
{
  _layer_compound_combination::reset_data();
  Qtw_layer_compound_combination_a->parameter1(parameter1());
  hide();
}

/*************************************************************************/

void _layer_compound_combination_ui::show()
{
  Qtw_layer_compound_combination_a->show();
}

/*************************************************************************/

void _layer_compound_combination_ui::hide()
{
  Qtw_layer_compound_combination_a->hide();
}

/*************************************************************************/

void *_layer_compound_combination_ui::get_link()
{
  return Qtw_layer_compound_combination_a->get_link();
}

/*************************************************************************/

void _layer_compound_combination_ui::enable()
{
  Qtw_layer_compound_combination_a->enable();
}

/*************************************************************************/

void _layer_compound_combination_ui::disable()
{
  Qtw_layer_compound_combination_a->disable();
}

/*************************************************************************/

void _layer_compound_combination_ui::parameter1_ui(float Value)
{
  Qtw_layer_compound_combination_a->parameter1(int(Value*255.0f));
}

/*************************************************************************/

void _layer_compound_combination_ui::parameter2_ui(float Value)
{
  Qtw_layer_compound_combination_a->parameter2(int(Value*255.0f));
}

/*************************************************************************/

void _layer_compound_combination_ui::parameter3_ui(float Value)
{
  Qtw_layer_compound_combination_a->parameter3(int(Value*255.0f));
}

/*************************************************************************/

void _layer_compound_combination_ui::parameter4_ui(int Value)
{
  Qtw_layer_compound_combination_a->parameter4(Value);
}

/*************************************************************************/

void _layer_compound_combination_ui::data_type_print(_palette_data_ns::_data_type_print Data_type_print1)
{
  Data_type_print=Data_type_print1;
  Qtw_layer_compound_combination_a->parameter4(int(Data_type_print1));
}

/*************************************************************************/

_qtw_layer_compound_combination::_qtw_layer_compound_combination(_window *Window1,_layer_compound_combination_ui *Filter1,std::string Box_name)
{
  Window=Window1;
  Filter=Filter1;
...
void _qtw_layer_compound_combination::parameter1(int Value)
{
...
void _qtw_layer_compound_combination::parameter2(int Value)
{
...
void _qtw_layer_compound_combination::parameter3(int Value)
{
...
void _qtw_layer_compound_combination::parameter4(int Value)
{
...
void _qtw_layer_compound_combination::parameter1_slot(int Value)
{
...
void _qtw_layer_compound_combination::parameter2_slot(int Value)
{
...
void _qtw_layer_compound_combination::parameter3_slot(int Value)
{
...
void _qtw_layer_compound_combination::parameter4_slot(int Value)
{
  Filter->parameter2(Value);
