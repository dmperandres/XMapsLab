...
{
public:
  _layer_map_distance_ui(_window *Window1, std::string Name1=_layer_map_distance_ns::BOX_TEXT);
...
class _qtw_layer_map_distance: public QWidget
{
  Q_OBJECT
public:
  _qtw_layer_map_distance(_window *Window1,_layer_map_distance_ui *Filter1,std::string Box_name="Canny parameters");
