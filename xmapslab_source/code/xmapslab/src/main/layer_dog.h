...
class _layer_dog : public _layer
{
public:
  _layer_dog();
  void reset_data();
...
{
public:
  _layer_dog_ui(_window *Window1, std::string Name1=_layer_dog_ns::BOX_TEXT);
  ~_layer_dog_ui();
  void reset_data();
...
class _qtw_layer_dog: public QWidget
{
  Q_OBJECT
public:
  _qtw_layer_dog(_window *Window1,_layer_dog_ui *Filter1,std::string Box_name=_layer_dog_ns::BOX_TEXT);
