...
{
  Layer_type=_layer_ns::_layer_type::LAYER_TYPE_MAP_RBF_INTERPOLATION;
}
...
_layer_map_rbf_interpolation_ui::_layer_map_rbf_interpolation_ui(_window *Window1, std::string Name1)
{
  Window=Window1;
  Name=Name1;
...
_qtw_layer_map_rbf_interpolation::_qtw_layer_map_rbf_interpolation(_window *Window1,_layer_map_rbf_interpolation_ui *Filter1,std::string Box_name)
{
  Window=Window1;
  Filter=Filter1;
