...
using namespace _layer_positions_ns;
...
void _layer_positions::reset_data()
{
  Transparency=0;
  Pixel_transparency=false;
}
...
void _layer_positions::add_valid_coordinates(std::vector<bool> Vec_valid_coordinates1)
{
...
void _layer_positions::add_coordinates(std::vector<float> Vec_coordinate_x1, std::vector<float> Vec_coordinate_y1)
{
...
void _layer_positions::add_coordinates_with_corners(std::vector<float> Vec_coordinate_x1, std::vector<float> Vec_coordinate_y1)
{
...
void _layer_positions::parameters(int Display_font_size1, int Display_out_circle_size1, QColor Display_font_color1, QColor Display_out_circle_color1, QColor Display_in_circle_color1)
{
...
void _layer_positions::draw(QPainter &Painter,float Width1,float Height1)
{
...
_layer_positions_ui::_layer_positions_ui(_window *Window1, std::string Name1)
{
  Window=Window1;
  Name=Name1;
  Qtw_layer_positions=new _qtw_layer_positions(Window1,this,Name);
}

/*************************************************************************/

_layer_positions_ui::~_layer_positions_ui()
{
  delete Qtw_layer_positions;
}

/*************************************************************************/

void _layer_positions_ui::reset_data()
{
  _layer_positions::reset_data();
  Qtw_layer_positions->parameter1(parameter1());
  hide();
}

/*************************************************************************/

void _layer_positions_ui::show()
{
  Qtw_layer_positions->show();
}

/*************************************************************************/

void _layer_positions_ui::hide()
{
  Qtw_layer_positions->hide();
}

/*************************************************************************/

void *_layer_positions_ui::get_link()
{
  return Qtw_layer_positions->get_link();
}

/*************************************************************************/

void _layer_positions_ui::enable()
{
  Qtw_layer_positions->enable();
}

/*************************************************************************/

void _layer_positions_ui::disable()
{
  Qtw_layer_positions->disable();
}

/*************************************************************************/

_qtw_layer_positions::_qtw_layer_positions(_window *Window1,_layer_positions_ui *Filter1,std::string Box_name)
{
  Window=Window1;
  Filter=Filter1;
...
void _qtw_layer_positions::parameter1(int Value)
{
  QString Str;
...
void _qtw_layer_positions::parameter2(int Value)
{
  QString Str;
...
void _qtw_layer_positions::parameter1_slot(int Value)
{
  QString Str;
  char Aux[100];
...
void _qtw_layer_positions::parameter2_slot(int Value)
{
