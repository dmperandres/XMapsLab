...
#ifndef LAYER_COMPOUND_COMBINATION_H
#define LAYER_COMPOUND_COMBINATION_H
...
#define DEFINED_LAYER_COMPOUND_COMBINATION

namespace _layer_compound_combination_ns
{
  // parameter 1
...
class _window;
class _qtw_layer_compound_combination;

/*************************************************************************/

class _layer_compound_combination: public _layer_map
{
public:
  _layer_compound_combination();
  ~_layer_compound_combination();
...
class _layer_compound_combination_ui : public _layer_compound_combination
{
public:
  _layer_compound_combination_ui(_window *Window1, std::string Name1=_layer_compound_combination_ns::BOX_TEXT);
  ~_layer_compound_combination_ui();
  void reset_data();
...
//  void get_parameters(std::map<std::string,std::string> &Parameters);
  ...
  void parameter1(int Value){_layer_compound_combination::transparency(float(Value)/255.0f);}
  void parameter1_ui(float Value);
  int parameter1(){return int(_layer_compound_combination::transparency()*255.0f);}

  void parameter2(int Value){_layer_compound_combination::color_mixing_min(float(Value)/255.0f);}
  void parameter2_ui(float Value);
  int parameter2(){return int(_layer_compound_combination::color_mixing_min()*255.0f);}

  void parameter3(int Value){_layer_compound_combination::color_mixing_max(float(Value)/255.0f);}
  void parameter3_ui(float Value);
  int parameter3(){return int(_layer_compound_combination::color_mixing_max()*255.0f);}

  void parameter4(int Value){_layer_compound_combination::data_type_print(_palette_data_ns::_data_type_print(Value));}
  void parameter4_ui(int Value);
  int parameter4(){return int(_layer_compound_combination::data_type_print());}
...
private:
  _qtw_layer_compound_combination *Qtw_layer_compound_combination_a=nullptr;
};

/*************************************************************************/

class _qtw_layer_compound_combination: public QWidget
{
  Q_OBJECT
public:
  _qtw_layer_compound_combination(_window *Window1,_layer_compound_combination_ui *Filter1,std::string Box_name="Canny parameters");
...
//  QLineEdit *Line_edit_parameter1=nullptr;
  ...
  _layer_compound_combination_ui *Filter=nullptr;
