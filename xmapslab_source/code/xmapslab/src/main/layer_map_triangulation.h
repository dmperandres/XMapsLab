...
{
public:
  _layer_map_triangulation_ui(_window *Window1, std::string Name1=_layer_map_triangulation_ns::BOX_TEXT);
...
class _qtw_layer_map_triangulation: public QWidget
{
  Q_OBJECT
public:
  _qtw_layer_map_triangulation(_window *Window1,_layer_map_triangulation_ui *Filter1,std::string Box_name="Canny parameters");
