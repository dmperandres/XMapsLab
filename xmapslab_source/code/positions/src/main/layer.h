...
namespace _f_layer_ns
{
   typedef enum {LAYER_TYPE_BASIC,LAYER_TYPE_CANNY,LAYER_TYPE_DOG,LAYER_TYPE_KANG,LAYER_TYPE_ELEMENT,LAYER_TYPE_ELEMENT_A,LAYER_TYPE_COMBINATION,LAYER_TYPE_POSITIONS} _layer_type;
}
...
public:
  ...
  _f_layer_ns::_layer_type layer_type(){return Layer_type;}
...
protected:
  ...
  _f_layer_ns::_layer_type Layer_type;
