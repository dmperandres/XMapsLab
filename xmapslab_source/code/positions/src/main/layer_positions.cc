...
{
  Layer_type=_f_layer_ns::LAYER_TYPE_POSITIONS;
}
...
void _layer_positions::add_input_data(std::vector<_common_ns::_position_data> &Vec_positions1)
{
...
void _layer_positions::parameters(int Display_font_size1, int Display_out_circle_size1, QColor Display_font_color1, QColor Display_out_circle_color1, QColor Display_in_circle_color1, QColor Display_selection_out_circle_color1, QColor Display_selection_in_circle_color1)
{
...
void _layer_positions::draw(QPainter &Painter, float Width1, float Height1, int Font_size1, int Out_circle_size1, QColor Font_color1, QColor Out_circle_color1, QColor In_circle_color1)
{
  float Pos_x;
  float Pos_y;
