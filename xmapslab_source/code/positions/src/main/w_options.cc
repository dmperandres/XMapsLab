...
_w_options::_w_options(_window *Window1):QDialog((QWidget*)Window1)
{
  ...
  Spinbox_positions_font_size_display->setValue(Window->positions_font_size_display());

  Spinbox_positions_out_circle_size_display=new QSpinBox;
  Spinbox_positions_out_circle_size_display->setValue(Window->positions_out_circle_size_display());

  Button_positions_font_color_display=new _button_color_simple(Window->positions_font_color_display(),false);
  Button_positions_out_circle_color_display=new _button_color_simple(Window->positions_out_circle_color_display(),false);
  Button_positions_in_circle_color_display=new _button_color_simple(Window->positions_in_circle_color_display(),false);
  Button_positions_selection_out_circle_color_display=new _button_color_simple(Window->positions_selection_out_circle_color_display(),false);
  Button_positions_selection_in_circle_color_display=new _button_color_simple(Window->positions_selection_in_circle_color_display(),false);
  ...
  Spinbox_positions_font_size_print->setValue(Window->positions_font_size_print());

  Spinbox_positions_out_circle_size_print=new QSpinBox;
  Spinbox_positions_out_circle_size_print->setValue(Window->positions_out_circle_size_print());

  Button_positions_font_color_print=new _button_color_simple(Window->positions_font_color_print(),false);
  Button_positions_out_circle_color_print=new _button_color_simple(Window->positions_out_circle_color_print(),false);
  Button_positions_in_circle_color_print=new _button_color_simple(Window->positions_in_circle_color_print(),false);
...
void _w_options::copy_to_print_slot(int Value)
{
