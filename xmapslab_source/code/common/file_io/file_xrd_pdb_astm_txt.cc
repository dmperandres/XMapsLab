...
bool _file_xrd_pdb_astm_txt::read(std::vector<std::string> &Vec_names, std::vector<std::string> &Vec_formulas, std::vector<std::string> &Vec_elements, _vertex3f &Color, std::vector<float> &Vec_2theta, std::vector<float> &Vec_intensity, std::vector<float> &Vec_d_spacing, std::string &Error)
{
//  float Value;
...
//void _file_xrd_pdb_astm_txt::write(vector<float> &Vec_data)
//{
