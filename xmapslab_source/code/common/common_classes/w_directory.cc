...
_w_directory::_w_directory(_window *Window1, QString Path1, QString *Directory1):
...
//  Vertical_layout->setContentsMargins(0,0,0,0);
  ...
  setWindowTitle("Select project directory");
...
void _w_directory::select_slot()
{
  if  (*Directory!=""){
    *Directory=Path+'/'+(*Directory);
    ...
    QMessageBox::information(this,"Information","Please, select a directory");
  }
}
