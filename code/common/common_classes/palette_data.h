...
namespace _palette_data_ns {
  ...
  enum class _palette_color_assigning_type:unsigned char {PALETTE_COLOR_ASSIGNING_MUTABLE, PALETTE_COLOR_ASSIGNING_FIXED};
  const _palette_color_assigning_type PALETTE_COLOR_ASSIGNING_DEFAULT=_palette_color_assigning_type::PALETTE_COLOR_ASSIGNING_MUTABLE;
  ...
  const QColor MUTABLE_COLOR=Qt::red;
  ...
  class _palette_data
  {
    ...
    _palette_data(QString Name1, _palette_data_ns::_palette_type Palette_type1, _palette_data_ns::_palette_color_type Palette_color_type1, int Num_stops1, _palette_color_assigning_type Palette_color_assigning1, QColor Color1, std::vector<_vertex3f> Colors_fixed_palette1, _color_map_ns::_color_for_zero_value Color_for_zero_value1);
