...
public:
    // PROJECT_DATA_CSV
static bool load_project_data_csv(QWidget *Window, std::string Project_dir, _project_data_ns::_project_data &Project_data, std::vector<std::string> &Vec_xrf_pdb_names,std::vector<std::string> &Vec_xrd_pdb_names);
  static bool save_project_data_csv(QWidget *Window, std::string Project_dir, _project_data_ns::_project_data &Project_data);

  // XRF_DATA_CSV
  static bool xrf_load_interpreted_csv(QWidget *Window, std::string File_name, std::vector<_project_data_ns::_interpreted_data> &Vec_sampled_data, std::vector<std::string> &Vec_names_pdb);
  ...
  // XRF_INTERPRETED_CSV
  static bool save_xrf_interpreted_csv(QWidget *Window, std::string Project_dir, std::vector<_project_data_ns::_interpreted_data> &Vec_interpreted_data);
