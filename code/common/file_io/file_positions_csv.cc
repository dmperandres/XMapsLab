  ...
  try{
    ...
    if (Tokens.size()>1 && Token=="WIDTH"){
      ...
      if (Tokens.size()>1 && Token=="HEIGHT"){
        ...
        // read the data
        Project_data.Vec_coordinates_x.clear();
        Project_data.Vec_coordinates_y.clear();
        ...
        while (get_new_line(File,Token)==true){
          ...
          if (Tokens.size()>=3){
            ...
            Project_data.Vec_coordinates_x.push_back(Value*Project_data.Width_pixel/Width1);
            ...
            Project_data.Vec_coordinates_y.push_back(Value*Project_data.Height_pixel/Height1);
          }
        }
      }
      else{
