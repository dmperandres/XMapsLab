...
public:
  ...
  void parameters(std::vector<bool> Parameters1){Parameters=Parameters1;}
  void distance_normalization(bool Distance_normalization1){Distance_normalization=Distance_normalization1;}
  void position_normalization(bool Position_normalization1){Position_normalization=Position_normalization1;}
...
protected:
  ...
  std::vector<bool> Parameters={true,true,true,true,true};
  bool Distance_normalization=_layer_map_ns::DISTANCE_INTERPOLATION_DEFAULT;
  bool Position_normalization=_layer_map_ns::POSITION_INTERPOLATION_DEFAULT;
  int Probe=0;
