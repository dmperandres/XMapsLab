...
_filter_logic_bin::_filter_logic_bin()
{
}

//HEA

void _filter_logic_bin::reset_data()
{
}

//HEA

void _filter_logic_bin::update()
{
  float Value0=0;
...
_filter_logic_bin_ui::_filter_logic_bin_ui(_window_xmapslab *Window1, std::string Name1)
{
  Name=Name1;
  Qtw_filter_logic_bin=new _qtw_filter_logic_bin(Window1,this,Name1);
}

//HEA

_filter_logic_bin_ui::_filter_logic_bin_ui(_window_xmapslab *Window1, std::map<std::string, std::string> &Parameters, std::string Name1)
{
...
_filter_logic_bin_ui::~_filter_logic_bin_ui()
{
  delete Qtw_filter_logic_bin;
}

//HEA

void _filter_logic_bin_ui::reset_data()
{
  _filter_logic_bin::reset_data();
  Qtw_filter_logic_bin->parameter1(parameter1());
  hide();
}

//HEA

void _filter_logic_bin_ui::show()
{
  Qtw_filter_logic_bin->show();
}

//HEA

void _filter_logic_bin_ui::hide()
{
  Qtw_filter_logic_bin->hide();
}

//HEA

void *_filter_logic_bin_ui::get_link()
{
  return Qtw_filter_logic_bin->get_link();
}

//HEA

void _filter_logic_bin_ui::read_parameters(std::map<std::string,std::string> &Parameters)
{
  if (Parameters["_INI_"]=="EDITOR"){// default parameters
    parameter1(_f_logic_bin_ns::THRESHOLD_DEFAULT);
  }
  else{// Parameters from file or from initialised filter
    try{
      if (Parameters["threshold"]=="default") parameter1(_f_logic_bin_ns::THRESHOLD_DEFAULT);
...
void _filter_logic_bin_ui::write_parameters(std::map<std::string,std::string> &Parameters)
{
  char Aux[100];
...
_qtw_filter_logic_bin::_qtw_filter_logic_bin(_window_xmapslab *Window1,_filter_logic_bin_ui *Filter1,std::string Box_name)
{
  Window=Window1;
  Filter=Filter1;
  ...
  Spinbox_parameter1->setToolTip(tr(_f_logic_bin_ns::String_parameter1_tooltip.c_str()));
...
void _qtw_filter_logic_bin::parameter1(int Value)
{
...
//void _qtw_filter_logic_bin::parameter2(QColor Color1)
//{
...
void _qtw_filter_logic_bin::parameter1_slot(int Value)
{
...
//void _qtw_filter_logic_bin::parameter2_slot(QColor Color1)
//{
