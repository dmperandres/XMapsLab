...
{
public:
  _layer_map_rbf_interpolation_ui(_window_xmapslab *Window1, std::string Name1=_layer_map_rbf_interpolation_ns::BOX_TEXT);
...
class _qtw_layer_map_rbf_interpolation: public QWidget
{
  Q_OBJECT
public:
  _qtw_layer_map_rbf_interpolation(_window_xmapslab *Window1,_layer_map_rbf_interpolation_ui *Filter1,std::string Box_name="Canny parameters");
