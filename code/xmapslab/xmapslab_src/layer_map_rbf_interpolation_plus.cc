...
_layer_map_rbf_interpolation_plus::_layer_map_rbf_interpolation_plus()
{
  Type=_layer_xmapslab_ns::_type::TYPE_MAP;
  Subtype=_layer_xmapslab_ns::_subtype::SUBTYPE_RBF_INTERPOLATION;
}
...
void _layer_map_rbf_interpolation_plus::add_input_data(std::vector<float> &Vec_coordinate_x1, std::vector<float> &Vec_coordinate_y1,  std::vector<float> &Vec_value1, float Epsilon1, std::vector<cv::Vec4f> &Vec_colors1)
{
  ...
  for (unsigned int i=0;i<Vec_active_positions.size();i++){
    if (Vec_active_positions[i]==true){
      ...
      Colors.push_back(Vec_colors1[i]);
...
void _layer_map_rbf_interpolation_plus::update_map()
{
  ...
  if (Computed==false){
    ...
    *Image_normalized=Vec_input_images[0]->clone();
    ...
    if (Max_dimension<=_layer_map_ns::MAX_DIMENSION_DEFAULT){
      ...
      // get the original image and get a scaled version

      cv::resize(*Image_normalized.get(),*Image_normalized.get(),cv::Size(Width_aux,Height_aux),0,0,cv::INTER_CUBIC);
    }
...
//    RBF.set_input_data(Coordinates_x,Coordinates_y,Intensities,Epsilon);
    ...
    _new_rbf_interpolation_2d_plus RBF;
    RBF.set_input_data(Coordinates_x,Coordinates_y,Intensities,Epsilon,Colors,Image_normalized);
...
void _layer_map_rbf_interpolation_plus::update()
{
  update_map();
}
...
_layer_map_rbf_interpolation_plus_ui::_layer_map_rbf_interpolation_plus_ui(_window_xmapslab *Window1, std::string Name1)
{
  Window=Window1;
  Name=Name1;
  Qtw_layer_map_rbf_interpolation_plus_a=new _qtw_layer_map_rbf_interpolation_plus(Window1,this,Name);
}

//HEA

_layer_map_rbf_interpolation_plus_ui::~_layer_map_rbf_interpolation_plus_ui()
{
  delete Qtw_layer_map_rbf_interpolation_plus_a;
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::reset_data()
{
  _layer_map_rbf_interpolation_plus::reset_data();
  Qtw_layer_map_rbf_interpolation_plus_a->parameter1(parameter1());
  hide();
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::show()
{
  Qtw_layer_map_rbf_interpolation_plus_a->show();
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::hide()
{
  Qtw_layer_map_rbf_interpolation_plus_a->hide();
}

//HEA

void *_layer_map_rbf_interpolation_plus_ui::get_link()
{
  return Qtw_layer_map_rbf_interpolation_plus_a->get_link();
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::enable()
{
  Qtw_layer_map_rbf_interpolation_plus_a->enable();
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::disable()
{
  Qtw_layer_map_rbf_interpolation_plus_a->disable();
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::parameter1_ui(float Value)
{
  Qtw_layer_map_rbf_interpolation_plus_a->parameter1(int(Value*255.0f));
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::parameter2_ui(float Value)
{
  Qtw_layer_map_rbf_interpolation_plus_a->parameter2(int(Value*255.0f));
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::parameter3_ui(float Value)
{
  Qtw_layer_map_rbf_interpolation_plus_a->parameter3(int(Value*255.0f));
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::parameter4_ui(int Value)
{
  Qtw_layer_map_rbf_interpolation_plus_a->parameter4(Value);
}

//HEA

void _layer_map_rbf_interpolation_plus_ui::data_type_print(_palette_data_ns::_data_type_print Data_type_print1)
{
  Data_type_print=Data_type_print1;
  Qtw_layer_map_rbf_interpolation_plus_a->parameter4(int(Data_type_print1));
}

//HEA

_qtw_layer_map_rbf_interpolation_plus::_qtw_layer_map_rbf_interpolation_plus(_window_xmapslab *Window1,_layer_map_rbf_interpolation_plus_ui *Filter1,string Box_name)
{
  Window=Window1;
  Filter=Filter1;
...
void _qtw_layer_map_rbf_interpolation_plus::parameter1(int Value)
{
...
void _qtw_layer_map_rbf_interpolation_plus::parameter2(int Value)
{
...
void _qtw_layer_map_rbf_interpolation_plus::parameter3(int Value)
{
...
void _qtw_layer_map_rbf_interpolation_plus::parameter4(int Value)
{
...
void _qtw_layer_map_rbf_interpolation_plus::parameter1_slot(int Value)
{
...
void _qtw_layer_map_rbf_interpolation_plus::parameter2_slot(int Value)
{
...
void _qtw_layer_map_rbf_interpolation_plus::parameter3_slot(int Value)
{
...
void _qtw_layer_map_rbf_interpolation_plus::parameter4_slot(int Value)
{
  Filter->parameter2(Value);
