...
public:
  ...
  void draw_positions(bool Draw_positions1, bool Draw_position_numbers1){
    Draw_positions=Draw_positions1;
    Draw_position_numbers=Draw_position_numbers1;
  }
...
protected:
  ...
  bool Draw_position_numbers=false;
