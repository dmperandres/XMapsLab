...
void phi5_a ( int n, double r[], double r0, double v[] )
{
  int i;
...
//  for (unsigned int i=0;i<nd*nd;i++){
//    std::cout << "i=" << i << " a=" << a[i] << endl;
//  }
