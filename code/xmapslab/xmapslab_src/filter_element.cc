...
void _filter_element::update()
{
  ...
  // shared_ptr<cv::Mat> Input_A=Vec_output_data[0];
  // std::cout << "Element (2025,2670) " << Input_A->at<float>(2025,2670) << std::endl;
  // std::cout << "Element (2025,598) " << Input_A->at<float>(2025,598) << std::endl;
}
