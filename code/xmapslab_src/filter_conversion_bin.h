...
#ifndef FILTER_CONVERSION_BIN
#define FILTER_CONVERSION_BIN
...
#define DEFINED_FILTER_CONVERSION_BIN

namespace _f_conversion_bin_ns
{
  // parameter 1
...
class _qtw_filter_conversion_bin;

/*************************************************************************/

class _filter_conversion_bin : public _filter
{
public:
  _filter_conversion_bin();
  void reset_data();
...
class _filter_conversion_bin_ui : public _filter_conversion_bin
{
public:
  _filter_conversion_bin_ui(_window_xmapslab *Window1,std::string Name1=_f_conversion_bin_ns::FILTER_NAME);
  _filter_conversion_bin_ui(_window_xmapslab *Window1,std::map<std::string,std::string> &Parameters,std::string Name1=_f_conversion_bin_ns::FILTER_NAME);
  ~_filter_conversion_bin_ui();
  void reset_data();
...
//  void color(QColor Color1);
  ...
  void parameter1(int Value){_filter_conversion_bin::threshold(Value);}
  int parameter1(){return _filter_conversion_bin::threshold();}

//  void parameter2(QColor Color1){_filter_conversion_bin::color(Color1);}
//  QColor parameter2(){return _filter_conversion_bin::color();}

private:
  _qtw_filter_conversion_bin *Qtw_filter_conversion_bin=nullptr;
};

/*************************************************************************/

class _qtw_filter_conversion_bin: public QWidget
{
  Q_OBJECT
public:

  _qtw_filter_conversion_bin(_window_xmapslab *Window1,_filter_conversion_bin_ui *Filter1,std::string Box_name=_f_conversion_bin_ns::FILTER_NAME);
...
//  _button_color_simple *Button_parameter2=nullptr;
  ...
  _filter_conversion_bin_ui *Filter=nullptr;
