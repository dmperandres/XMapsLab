...
//  std::vector<QColor> compute_palette_colors(int Pos_palette, _project_data_ns::_data_type Data_type1, std::string Name_element1);
  ...
  _color_bar_abstract *create_color_bar(_palette_data_ns::_palette_data Palette1, _common_ns::_xray_data_type Data_type1, std::string Name_element1, float Max_value, std::vector<QColor> &Colors, _palette_data_ns::_data_type_print Data_type_print1, _color_map_ns::_color_for_zero_value Color_for_zero_value1);
