...
_filter_arithmetic_addition::_filter_arithmetic_addition()
{
}

/*************************************************************************/

void _filter_arithmetic_addition::reset_data()
{
}

/*************************************************************************/

void _filter_arithmetic_addition::update()
{
  float Value0=0;
  float Value1=0;
  ...
  for (int Row=0;Row<Input_A->rows;Row++){
    for (int Col=0;Col<Input_A->cols;Col++){
      ...
      if (Value0>Threshold1 && Value1>Threshold1){
        Output->at<unsigned char>(Row,Col)=static_cast<unsigned char>((Value0+Value1)*255.0f/2.0f);
      }
      else{
...
_filter_arithmetic_addition_ui::_filter_arithmetic_addition_ui(_window_xmapslab *Window1, std::string Name1)
{
  Name=Name1;
  Qtw_filter_arithmetic_addition=new _qtw_filter_arithmetic_addition(Window1,this,Name1);
}

/*************************************************************************/

_filter_arithmetic_addition_ui::_filter_arithmetic_addition_ui(_window_xmapslab *Window1, std::map<string, string> &Parameters, std::string Name1)
{
...
_filter_arithmetic_addition_ui::~_filter_arithmetic_addition_ui()
{
  delete Qtw_filter_arithmetic_addition;
}

/*************************************************************************/

void _filter_arithmetic_addition_ui::reset_data()
{
  _filter_arithmetic_addition::reset_data();
  Qtw_filter_arithmetic_addition->parameter1(parameter1());
  hide();
}

/*************************************************************************/

void _filter_arithmetic_addition_ui::show()
{
  Qtw_filter_arithmetic_addition->show();
}

/*************************************************************************/

void _filter_arithmetic_addition_ui::hide()
{
  Qtw_filter_arithmetic_addition->hide();
}

/*************************************************************************/

void *_filter_arithmetic_addition_ui::get_link()
{
  return Qtw_filter_arithmetic_addition->get_link();
}

/*************************************************************************/

void _filter_arithmetic_addition_ui::read_parameters(std::map<std::string,std::string> &Parameters)
{
  if (Parameters["_INI_"]=="EDITOR"){// default parameters
    parameter1(_f_arithmetic_addition_ns::THRESHOLD_DEFAULT);
  }
  else{// Parameters from file or from initialised filter
    try{
      if (Parameters["threshold"]=="default") parameter1(_f_arithmetic_addition_ns::THRESHOLD_DEFAULT);
...
void _filter_arithmetic_addition_ui::write_parameters(std::map<std::string,std::string> &Parameters)
{
  char Aux[100];
...
_qtw_filter_arithmetic_addition::_qtw_filter_arithmetic_addition(_window_xmapslab *Window1,_filter_arithmetic_addition_ui *Filter1,string Box_name)
{
  Window=Window1;
  Filter=Filter1;
...
void _qtw_filter_arithmetic_addition::parameter1(int Value)
{
...
void _qtw_filter_arithmetic_addition::parameter1_slot(int Value)
{
