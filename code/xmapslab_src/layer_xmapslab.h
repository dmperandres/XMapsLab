...
{
   enum class _layer_type: unsigned char {LAYER_TYPE_BASIC,LAYER_TYPE_CANNY,LAYER_TYPE_DOG,LAYER_TYPE_KANG,LAYER_TYPE_MAP_DISTANCE,LAYER_TYPE_MAP_TRIANGULATION, LAYER_TYPE_MAP_RBF_INTERPOLATION,LAYER_TYPE_MAP_RBF_FAST_INTERPOLATION, LAYER_TYPE_KMEANS, LAYER_TYPE_COMPOUND_COMBINATION,LAYER_TYPE_MAP_LAB};
...
//  std::shared_ptr<cv::Mat> image_alpha_channel(){return Image_alpha_channel;}
  ...
  _layer_xmapslab_ns::_layer_type layer_type(){return Layer_type;}
...
//  std::shared_ptr<cv::Mat> Image_alpha_channel=nullptr;
  ...
  _layer_xmapslab_ns::_layer_type Layer_type;
