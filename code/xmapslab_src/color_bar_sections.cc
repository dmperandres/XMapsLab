...
_color_bar_sections::_color_bar_sections(_palette_data_ns::_palette_color_type Palette_color_type1, int Num_stops1, std::vector<float> &Vec_values1, std::vector<QColor> &Vec_colors1, _color_map_ns::_color_for_zero_value Color_for_zero_value1, _window_xmapslab *Window1):
_color_bar_abstract(Palette_color_type1,Num_stops1,Vec_values1,Vec_colors1,Window1)
{
  ...
  Color_for_zero_value=Color_for_zero_value1;
      ...
      if (Event->button()==Qt::LeftButton){
        if (Palette_color_type==_palette_data_ns::_palette_color_type::PALETTE_COLOR_TYPE_SINGLE_TONE){
          if (Pos==Num_stops-2){
            ...
            _dialog_pure_color Dialog(&Color);
